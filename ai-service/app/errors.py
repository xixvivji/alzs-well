...
ERROR_EXIT_CODES: dict[str, int] = {
    ...
    "EMBEDDING_CONFIGURATION_INVALID": 2,
    "EMBEDDING_MODEL_UNAVAILABLE": 6,
    "EMBEDDING_VECTOR_INVALID": 5,
    "INTERNAL_AUTHENTICATION_FAILED": 3,
    "KNOWLEDGE_PERMISSION_DENIED": 3,
    "SEARCH_REQUEST_INVALID": 2,
    "SEARCH_REQUEST_CONFLICT": 6,
    "SEARCH_TIMEOUT": 6,
    "AI_ASSISTANCE_REQUEST_INVALID": 2,
...
SAFE_MESSAGES: dict[str, str] = {
    ...
    "EMBEDDING_CONFIGURATION_INVALID": "내부 임베딩 모델 설정이 올바르지 않습니다.",
    "EMBEDDING_MODEL_UNAVAILABLE": "내부 임베딩 모델을 사용할 수 없습니다.",
    "EMBEDDING_VECTOR_INVALID": "임베딩 모델 출력이 벡터 계약을 충족하지 않습니다.",
    ...
    "SEARCH_TIMEOUT": "지식 검색 시간이 제한을 초과했습니다.",
    "AI_ASSISTANCE_REQUEST_INVALID": "AI 금융생활 지원 요청이 계약을 충족하지 않습니다.",
