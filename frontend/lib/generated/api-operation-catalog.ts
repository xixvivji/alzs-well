...
export const API_OPERATION_CATALOG = [
  ...
  {
    "key": "POST /api/v1/customers/{customerId}/ai-financial-assistance/change-analysis",
    "method": "POST",
    "path": "/api/v1/customers/{customerId}/ai-financial-assistance/change-analysis",
    "purpose": "로그인 합성 회원 기준선의 30·60·90일 변화 분석",
    "domain": "AI 금융생활 지원",
    "domainId": "ai-금융생활-지원",
    "priority": "P1",
    "boundary": "OWNED",
