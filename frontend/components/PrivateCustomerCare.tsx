...
function loginError(reason: unknown) { const message = messageOf(reason); return /404|찾을 수|등록되지/.test(message) ? "로그인할 수 없습니다. 아이디와 서비스 연결 상태를 확인해 주세요." : message; }
