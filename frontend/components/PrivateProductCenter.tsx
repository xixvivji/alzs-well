...
export function PrivateProductCenter() {
  ...
  if (!session || !overview) return <section className="panel private-login-panel">
    <div className="private-login-copy"><h2>내 금융정보는 로그인 후 조회합니다.</h2><p>보유 자산과 상품 정보를 확인해 보세요.</p></div>
