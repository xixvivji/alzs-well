...
export function DemoDashboard(){
 ...
 async function startDemo(){setLoading(true);setError("");try{const next=await createDemoContext();saveDemoContext(next);setContext(next);await load(next)}catch(reason){setError(messageOf(reason))}finally{setLoading(false)}}
