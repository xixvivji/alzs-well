...
export default function StaffOperationsPage() {
  return <AppShell mode="staff" staffRole="protection" title="보호업무 운영"><div className="operations-portal">
    ...
    <OperationalRoleDashboard mode="staff" />
    ...
    <div className="operations-heading"><div><p className="label">실제 사건 API 연결</p><h2>로그인 회원 보호사건</h2></div><span className="status-chip">고객→행원 폐루프</span></div>
    <StaffCaseWorkspace compact />
