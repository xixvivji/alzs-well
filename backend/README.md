...
현재 단위·PostgreSQL Testcontainers 통합시험 35개는 capability/IDOR, run 격리, 3·2·7 신호, A/B 정책, 멱등충돌, 낙관적 잠금, 미동의 연락 차단, 외부실행 금지, 감사 hash 체인·append-only 제약, 조회 입력·cursor 검증, 사건 타임라인·근거·코파일럿 격리와 OpenAPI 26개 계약을 검증한다.
